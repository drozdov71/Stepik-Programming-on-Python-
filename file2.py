...
амое частое слово в этом тексте и через пробел то, сколько раз оно встретилось. 
...
lst = list()
with open('C:/Users/Dmitry/Downloads/dataset_3363_3.txt', 'r') as f:
    for line in f:
        line = line.strip()
        lst.append(line)
...
with open('C:/Users/Dmitry/Downloads/dataset_3363_3.txt', 'w') as f:
    f.write(s)
